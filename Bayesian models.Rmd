...
h5 <- df_xd %>% ggplot() + geom_histogram(aes(x = temp.c), binwidth = .5) + xlim(-5,13) + facet_wrap(~ intervention + Site) + ggtitle("Data excluding default settings") + theme(plot.title = element_text(size = 10))
h5
