...
write.csv(survey, file = "SurveyData.csv", row.names = FALSE)
```
...
#Add survey data (cs) variables to time-series dataframe (df)

df <- left_join(irus_data, cs[,c("site_room", "Habit_sz")], by = "site_room")

df <- left_join(irus_data, cs[,c("site_room", "PBC_sz")], by = "site_room")
