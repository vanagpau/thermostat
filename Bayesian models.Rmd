...
mm4 <- lmer(temp.c ~ time_elapsed_r + intervention + (time_elapsed_r|Address), data = df)
summary(mm4)
...
#Adam' models
#Random effects of time, within room and site implicitly nested - convergence and "degenerate Hessian"!
mm7 <- lmer(temp.c ~ time_elapsed_r + intervention*Site + Ext_temp_celsius + (time_elapsed_r|Address) + (time_elapsed_r|Site), data = df)
summary(mm7)
