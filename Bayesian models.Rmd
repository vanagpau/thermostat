...
df %>% ggplot() + geom_histogram(aes(x = temp.c), binwidth = .5) + xlim(-5,13)
df_xd %>% ggplot() + geom_histogram(aes(x = temp.c), binwidth = .5) + xlim(-5,13)
df %>% ggplot() + geom_histogram(aes(x = temp.c), binwidth = .5) + xlim(-5,13)+ facet_wrap(df$intervention)
df_xd %>% ggplot() + geom_histogram(aes(x = temp.c), binwidth = .5) + xlim(-5,13) + facet_wrap(df_xd$intervention)
