...
#Create survey data data-frame by matching all completed surveys (cs) data to main df

#df_survey <- left_join(df, cs[,c("site_room", "Habit_sz", "PBC_sz", "moralisation.z",
                                  # "AscriptionResponsibility_sz", "SocialNorm_sz",
                                  # "AwarenessConsequences_sz", "PEB_pragmatist_sz",
                                  # "PEB_activist_sz", "NEP_mean")], by = "site_room")
